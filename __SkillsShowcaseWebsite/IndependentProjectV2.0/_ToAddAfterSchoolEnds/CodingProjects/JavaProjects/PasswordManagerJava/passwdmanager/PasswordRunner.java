...
public class PasswordRunner {
    ...
    public static void main(String[] args) {
        ...
        if(go = true){
                ...
                System.out.println("Welcome to the password generateor function.  Next you will answer four questions to determine the amount of letters, numbers, and symbols you want in your password.\n\tYour answers must:\n\t\t1.)Add up to a minimum of 8 character.\n\t\t2.)Must have at least 1 capital letter.\n\t\t3.)Must have at least 1 number.\n\t\t4.)Must have at least 1 special character.\n\tType 'quit' to quit program.");
                ...
                while(uPut = true){
                        System.out.println("First I need to ask you what the password is being used for?");
                        ...
                        if(category.equals("quit") || category.equals("Quit")){ //Scans for if the user wants to quit at this point in the program. If so it terminates the function.
                                ...
                                System.out.println("Now, how many lowercase letters? (must be written as an be integer)");
