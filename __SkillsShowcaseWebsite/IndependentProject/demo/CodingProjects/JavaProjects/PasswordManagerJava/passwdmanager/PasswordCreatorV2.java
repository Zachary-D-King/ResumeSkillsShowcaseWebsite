...
public class PasswordCreatorV2{
	public static String passwordGenerator(boolean Pass, boolean full){
	//Sets it to where if the arguement is set to true, it goes through the process of making a password for those who are already registered and logged in.
	//      If the args is set to false, then it just creates a password.
	...
	if(go = true){
		...
		if (start.equals("y")){
			System.out.println("Now, before we start making your new password, I need to ask you what the password is being used for?");
...
private static void modifyPassword(Library lukePWS) {
}

private static void PasswordRecord(String category, String newPassword) {
}
}